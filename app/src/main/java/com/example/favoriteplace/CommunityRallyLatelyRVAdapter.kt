...
class CommunityRallyLatelyRVAdapter(private val rallyLatelyList: ArrayList<GuestBook>, private val listener: OnItemClickListener): RecyclerView.Adapter<CommunityRallyLatelyRVAdapter.ViewHolder>(){
